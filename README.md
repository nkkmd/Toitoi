...
| Indexer operators | [`infra/indexers/nostr/INDEXER_API_SETUP.md`](./infra/indexers/nostr/INDEXER_API_SETUP.md) | Entry point for initial setup, rebuilds, and configuration review. `API_REFERENCE.md` and `packages/nostr/storage/` are the core implementation references. |
