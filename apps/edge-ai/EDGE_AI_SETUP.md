...
4.  **問いの二層構造（OVERVIEW.md / NOSTR_INQUIRY_SCHEMA.md 準拠）:**
...
※ 各タグの厳密な定義・標準ボキャブラリー・DSLサブキー定義については、**[`NOSTR_INQUIRY_SCHEMA.md`](../../docs/protocols/NOSTR_INQUIRY_SCHEMA.md)** を必ず参照して実装してください。
...
// 2. LLMが生成した「問い」のデータ構造 (※詳細は NOSTR_INQUIRY_SCHEMA.md 参照)
