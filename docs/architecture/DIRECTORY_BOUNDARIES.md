...
Toitoi の設計、思想、protocol、concepts、roadmap を整理するドキュメント群です。
...
Toitoi の viewer / UI layer を置きます。

UI、visualization、question graph、interaction layer を担当します。

## `apps/edge-ai/`

local-first AI inference layer を置きます。

生データを保持したまま問いを生成するための実行層です。
