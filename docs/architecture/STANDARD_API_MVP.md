...
UI / AI は Nostr / Lingonberry / ATProto の raw schema を直接扱わず、意味論に基づく view を受け取ります。

Phase 14 以降は、必要に応じて Nostr / Lingonberry / ATProto をまたいだ multi-transport の canonical view も同じ契約で返します。
...
- Nostr / Lingonberry / ATProto のどの transport へ投影しても同じ `id` を使う
...
- `packages/lingonberry/storage/replay.js`
- `packages/lingonberry/storage/persistence.js`
