...
function buildDerivedIndex(canonicalEvents) {
  ...
  for (const event of canonicalEvents) {
    ...
    for (const edge of lineage) {
      ...
      lineageChildrenByTarget[resolvedTargetId].push(eventId);
      if (!Array.isArray(lineageParentsBySource[eventId])) {
        lineageParentsBySource[eventId] = [];
      }
      lineageParentsBySource[eventId].push(resolvedTargetId);
    }
